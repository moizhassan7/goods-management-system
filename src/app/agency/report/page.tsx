...
export default function AgencyReportPage() {
  ...
  const totals = useMemo(() => {
    ...
    }, { totalAgencies: 0, totalShipments: 0, totalCharges: 0 });
  }, [agencies]);

  return (
    <div className='p-6 max-w-6xl mx-auto'>
      <h2 className='text-3xl font-bold mb-6 text-gray-800 border-b pb-2'>Agency Report</h2>
      ...
      {!loading && agencies.length === 0 && (
        <div className='p-4 text-gray-600'>No agencies found for the selected criteria.</div>
      )}
    </div>
  );
}
