/*
  ...
  - You are about to drop the `vehicle_ledger` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `vehicle_ledger_shipments` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `vehicle_ledger` DROP FOREIGN KEY `Vehicle_Ledger_arrival_city_id_fkey`;

-- DropForeignKey
ALTER TABLE `vehicle_ledger` DROP FOREIGN KEY `Vehicle_Ledger_departure_city_id_fkey`;

-- DropForeignKey
ALTER TABLE `vehicle_ledger` DROP FOREIGN KEY `Vehicle_Ledger_vehicle_number_id_fkey`;

-- DropForeignKey
ALTER TABLE `vehicle_ledger_shipments` DROP FOREIGN KEY `Vehicle_Ledger_Shipments_ledger_id_fkey`;

-- DropForeignKey
ALTER TABLE `vehicle_ledger_shipments` DROP FOREIGN KEY `Vehicle_Ledger_Shipments_shipment_id_fkey`;

-- DropTable
DROP TABLE `vehicle_ledger`;

-- DropTable
DROP TABLE `vehicle_ledger_shipments`;
...
CREATE TABLE `Trip_Log` (
    ...
    `munsihna` DECIMAL(10, 2) NOT NULL DEFAULT 0.00,
